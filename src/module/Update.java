...
public class Update {
    ...
    private List<Or> conditions;//OR条件组
    ...
    public DBFContent executeSQL() throws SqlException {// 执行语句
        ...
        List<Map<String, Object>> listNeedUpdate = new ArrayList<>();
...
//        System.out.println(content);
    ...
    //判断修改操作是否违背约束条件
    private void judgeConstraint(List<Map<String, Object>> temp) throws SqlException {
        DBFContent constaintContent = DBFUtils.getFileData(tableName+"constraint");
        for (Map<String, Object> constraint : constaintContent.getContents()) {
            ...
            if (((String) constraint.get("tableName")).equals(tableName)) {
                if (constraint.get("PrimaryKey").equals("true")) {
                    ...
                    for (Map<String, Object> recordInFile : temp) {
                        if (((String) recordInFile.get(constraint
                            ...
                            // 主键重复，抛出异常
                            throw new SqlException("该修改操作违背该表的主键约束，主键重复");
                        }
                    }
                    if ((value == null || value.equals("null")) && flag) {
                        // 主键为空，抛出异常
                        throw new SqlException("该修改操作违背该表的主键约束，主键为空");
                    }
                }
                if (constraint.get("Unique").equals("true")) {
                    ...
                    for (Map<String, Object> recordInFile : temp) {
                        ...
                        if (((String) recordInFile.get(constraint
                                .get("fieldName"))).equals(value)) {
                            // 违背唯一约束，抛出异常
                            throw new SqlException("该修改操作违背该表的唯一约束");
                        }
                    }
                }
                // 非空约束
                if (constraint.get("NotNull").equals("true")) {
                    ...
                    if ((value == null || value.equals("null")) && flag) {
                        // 违背非空约束，抛出异常
                        throw new SqlException("该修改操作违背该表的非空约束");
                    }
                }
            }
        }
    ...
    public Update(String tableName, String updateString, String whereString) throws SqlException {
        ...
        wheres.addAll(Arrays.asList(whereString.split(" ")));
        translateWhere();
    }

    private void translateWhere() throws SqlException {// 翻译Where字符串为OR条件组
            ...
            switch (w1) {
                ...
                default:
                    ...
                    if (w1.contains("<>")) {
                        ...
                        // 语句错误，抛出异常
                        throw new SqlException("含有该数据库不支持的条件语句");
                    }
                    break;
            }
        }
    ...
    public void singleAndTranslate(Or or, String w1,
        ...
        if (temp.length != 2) {
            ...
            throw new SqlException("条件语句中参数数目不正确");
        } else {
