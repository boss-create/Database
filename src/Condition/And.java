...
public class And {
    ...
    public And(String table, List<DBFField> fieldsOfTable) {
        flags = new int[10];
        ...
        switch (type) {
            case BETWEEN:
                try {
                    ...
                    // 转换出错，抛出异常，数据不是数字
                    throw new SqlException("Between...AND...参数中还有非数字");
                }
            case EQUAL:
                try {
                    ...
                    // 转换出错，抛出异常
                    throw new SqlException("数据类型转换错误");
                }
            case NOT_EQUAL:
                try {
                    String value1 = null, value2 = null;
                    ...
                    // 转换出错，抛出异常
                    throw new SqlException("数据类型转换出错");
                }
            case BIGGER:
                try {
                    String value1 = null, value2 = null;
                    ...
                    try {
                        ...
                        // 转换出错，不是数字
                        throw new SqlException(">比较参数中带有非数字");
                    }
                } catch (Exception exception) {
                    // 转换出错，抛出异常,不是数字
                    throw new SqlException(">比较参数中带有非数字");
